...
:asciidoctor-ant-maven-repo: http://mvnrepository.com/artifact/org.asciidoctor/asciidoctor-ant/
...
----
...
      <get src="http://repo2.maven.org/maven2/org/asciidoctor/ant/${asciidoctor-version}/asciidoctor-ant-${asciidoctor-version}.jar"
